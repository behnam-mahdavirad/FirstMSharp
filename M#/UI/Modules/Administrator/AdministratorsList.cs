...
namespace Modules
{
    public class AdministratorsList : ListModule<Domain.Administrator>
    {
        public AdministratorsList()
        {
            ...
            /*M#:w[26]T-Prop:SortingStatement-Type:ListButton-Sorting statement is assumed to be this anyway. No need to hard-code.*//*M#:w[26]T-Prop:Name-Type:ListButton-Button name should not contain underline.*/LinkColumn(x => x.Name)
                .OnClick(x =>
                {
